...
const MoneySent = () => {
    return (
        <ImageBackground source={background} style={{ alignContent: 'center', alignItems: 'center', height, width, position: 'absolute' }} resizeMode="cover">
            ...
            <Link href="/Trustly" asChild style={[tw`mt-5`, { alignSelf: 'flex-start' }]}>
                <Pressable >
            ...
            <View style={tw`mx-10 bg-white p-7 mt-7 rounded-lg `}>
                <CustomText style={tw`font-bold text-5 items-center`}>You sent 3468 SEK to Abdi</CustomText>
                ...
                <Pressable>
                    <CustomText style={tw`text-[${primary_color}] text-lg pt-7 text-center `}>Done</CustomText>
                </Pressable>
            </View>
        </ImageBackground>
    )
