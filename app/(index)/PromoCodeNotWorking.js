...
export default function PromoCodeNotWorking() {
        ...
        <View style={{ height }}>
            <ScrollView>
                ...
                <View style={[tw`mx-12`]} >
                    ...
                    <CustomText style={[tw`font-extrabold mt-9 text-2xl`]}>What should I do if I enter a promo code but it’s not working?</CustomText>
