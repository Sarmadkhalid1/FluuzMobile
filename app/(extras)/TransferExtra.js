    ...
    return (
        <ScrollView>
            <View>
                    ...
                    <View >
                        ...
                        <View style={tw`mx-auto mt-3`}>
                            <Card style={tw`py-3 px-5 h-16 w-60`} >
                                ...
                                <View style={tw`flex-row justify-between pb-2`}>
                                    <CustomText style={tw`font-semibold text-5`} >SEK54652.70</CustomText>
                                    <View style={tw`flex-row`}>
                                        <Image style={tw`h-4 w-6 mt-0.5`} source={se} />
                ...
                <View style={tw`mx-auto mt-10`}>
                    <Card >
                        <View style={tw`p-5 gap-3 `}>
                            ...
                            <View style={tw`flex-row justify-between border-t border-dashed pt-2 border-[${primary_color}]`}>
                ...
                <Link href="/MoneySentExtra" asChild>
                    <Pressable
