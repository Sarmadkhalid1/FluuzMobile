    ...
    return (
        <ScrollView>
            <View style={tw`mx-10`}>
                ...
                <Link href="/CashPickupExtra" asChild>
                ...
                <Link href="/MobileMoneyTransferExtra" asChild>
                    <TouchableOpacity style={tw`flex-row justify-between  mt-2 border-b pb-5 border-blue-700`}>
                        <View style={tw`flex-row`}>
                ...
                <Link href="/AddBankDetailsExtra" asChild>
                    <TouchableOpacity style={tw`flex-row justify-between mt-2 `}>
                        <View style={tw`flex-row`}>
